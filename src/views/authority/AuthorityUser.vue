<template>
  <div class="sys-user">
    ...
    v-on:enableSelect="enableSelect" v-on:onSubmit="onSubmit" v-on:resetSearch="resetSearch"></v-search-user>
    <v-add-user :dialogUser="dialogUser" :addOrEdit="addOrEdit" v-on:cancel="cancel" :userForm="userForm"></v-add-user>
