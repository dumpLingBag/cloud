        ...
        <el-row :gutter="20" class="item">
            <el-col :span="6">
                ...
                <el-select v-model="message.msgType" placeholder="请选择消息类型">
                    <el-option v-for="item in messageType" :label="item.dictLabel" :value="item.dictValue"></el-option>
                </el-select>
            </el-col>
            <el-col :span="6">
                <span class="item__label">是否弹窗：</span>
                <el-select v-model="message.popup" placeholder="请选择是否弹窗">
                    <el-option v-for="item in yesNo" :label="item.dictLabel" :value="item.dictValue"></el-option>
                </el-select>
            </el-col>
            <el-col :span="6">
