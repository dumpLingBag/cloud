                ...
                <el-row :gutter="20">
                    <el-col :span="24">
                        <el-form-item label="上级菜单">
                            <treeselect v-model="selectId" :show-count="true" placeholder="请选择上级菜单"
                                        :options="menuList"></treeselect>
                        </el-form-item>
                    </el-col>
                    <el-col :span="24">
                    ...
                    <el-col :span="24" v-if="nodeData.menuType !== '2'">
                        <el-form-item label="菜单图标" :prop="isMenuProp ? 'icon' : ''">
                            <el-popover placement="bottom-start" width="400" trigger="focus" popper-class="popper-icon"
                                        v-model="visible">
                                <vue-scroll>
                                    <ul class="icon-menu-list">
                                        <li v-for="item in iconList" @click="addIcon(item.icon)" :key="item.id"><i
                                                :class="item.icon"></i></li>
                                    </ul>
                                </vue-scroll>
                                <el-input v-model="nodeData.icon" :prefix-icon="nodeData.icon" slot="reference"
                                          @click="visible = !visible" placeholder="菜单展示图标"></el-input>
                            </el-popover>
                        </el-form-item>
                    </el-col>
                    <el-col :span="24" v-if="nodeData.menuType !== '2'">
